...
int main(int argc, char **argv)
{
  ...
  ros::init(argc, argv, "projector_demo");
  ...
  // cv::namedWindow( "screen2", CV_WINDOW_NORMAL );
  // cv::setWindowProperty("screen2",CV_WND_PROP_FULLSCREEN,CV_WINDOW_FULLSCREEN);
